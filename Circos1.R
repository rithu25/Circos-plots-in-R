...
### Motifs layer
my_data2 <-read.csv("group1ciiider.csv")

my_data2$CNV <- floor(runif(n=37701, min=1, max=7))
...
RCircos.Link.Data = read.csv("lo1.csv") 
